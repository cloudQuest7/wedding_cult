        ...
        <div 
          style={{
            backgroundImage: `
              ...
              radial-gradient(circle at 80% 20%, #D2691E 1px, transparent 1px),
              radial-gradient(circle at 40% 40%, #8B4513 1px, transparent 1px)
            `,
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-poppins text-sm font-semibold text-chocolate">500+ Couples</span>
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="font-poppins text-sm font-semibold text-chocolate ml-1">4.9</span>
            </div>
          </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-4 px-8 py-4 bg-white/60 backdrop-blur-sm rounded-full border border-chocolate/20 shadow-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="w-2 h-2 bg-chocolate rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
              <div className="w-2 h-2 bg-chocolate rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
            </div>
          </div>
        </div>
      </div>
